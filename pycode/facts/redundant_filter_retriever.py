...
class RedundantFilterRetriever(BaseRetriever):
    ...
    # Same for chroma instance in order not to hardcode the persis      t directory
    ...
    def get_relevant_documents(self, query):
        ...
        # Take the calculated embeddings above and feed them into
        # that max_marginal_relevance_search_by_vector
        return self.chroma.max_marginal_relevance_search_by_vector(
                embedding=emb,
                # In the following lambda ranges from 0 to 1
                # higher values indicate how much repetitiveness i                #  s allowed when removing redundancies
                lambda_mult=0.8
                )
